...
public class UsersController {
    ...
    @PostMapping("/update")
    public ApiResponse<UsersResponseDTO> updateUserInfo(@Schema(hidden = true) @UserID Long userID, @RequestBody UsersRequestDTO usersRequestDTO) {
    ...
    public ApiResponse<UsersResponseDTO> updateUserImg(@Schema(hidden = true) @UserID Long userID, @RequestPart String profileImg) {
    ...
    public ApiResponse<UsersResponseDTO> updateUserName(@Schema(hidden = true) @UserID Long userID, @RequestBody UsersNameRequestDTO usersNameRequestDTO) {
