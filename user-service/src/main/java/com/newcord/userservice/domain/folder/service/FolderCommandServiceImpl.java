...
import com.newcord.userservice.domain.folder.repository.FolderPostRepository;
import com.newcord.userservice.domain.folder.repository.FolderRepository;
...
public class FolderCommandServiceImpl implements FolderCommandService{
    ...
    @Override
    public FolderResponse.FolderResponseDTO addFolder(Long userID, String folderName) {
    ...
    @Override
    public FolderResponse.FolderResponseDTO deleteFolder(Long userID, String folderName) {
