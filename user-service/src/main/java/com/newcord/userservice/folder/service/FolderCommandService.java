...
public interface FolderCommandService {
    FolderResponse.FolderResponseDTO addFolder(FolderRequest.FolderRequestDTO folderAddDTO); // 폴더 생성
    FolderResponse.FolderResponseDTO deleteFolder(FolderRequest.FolderRequestDTO folderDeleteDTO); // 폴더 삭제
