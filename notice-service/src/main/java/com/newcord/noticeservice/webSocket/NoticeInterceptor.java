package com.newcord.noticeservice.webSocket;
...
public class NoticeInterceptor implements ChannelInterceptor {
    ...
    private void handleSubscription(String destination, StompHeaderAccessor headerAccessor) {
        if (destination.startsWith("/exchange")) {
            ...
            rabbitMQService.createDirectExchange(sessionID[2]);
        }
    }
